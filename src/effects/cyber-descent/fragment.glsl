...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  windowColorA *= iColorSaturation * iColorIntensity;
  windowColorB *= iColorSaturation * iColorIntensity;
  signColorA *= iColorSaturation * iColorIntensity;
  signColorB *= iColorSaturation * iColorIntensity;

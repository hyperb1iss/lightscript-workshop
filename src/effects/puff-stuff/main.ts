...
(window as any).update = function(force = false) {
  ...
  if (typeof globalColorScheme === 'string') {
    const schemes = ["Classic Blue", "Cyberpunk", "Fire", "Toxic", "Ethereal", "Monochrome", "Rainbow", "Electric", "Amethyst", "Coral Reef", "Deep Sea", "Emerald", "Neon", "Rose Gold", "Sunset", "Vapor Wave"];
  ...
  const globalColorSaturation = normalizePercentage((window as any).colorSaturation || 100);

...
export function initializeWebGL(options: WebGLSetupOptions = {}): WebGLContext {
    ...
    return { camera, canvas, clock, renderer, scene }
}
...
export function createShaderQuad(
    ...
    debug('debug', 'Shader material created with uniforms', Object.keys(uniforms))
 ...
 */
export function createStandardUniforms(canvas: HTMLCanvasElement): Record<string, THREE.IUniform> {

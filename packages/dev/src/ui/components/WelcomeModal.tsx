...
export const WelcomeModal: FunctionComponent<WelcomeModalProps> = ({ onClose }) => {
    ...
    return (
        <div className="welcome-modal">
            ...
            <p>
                Welcome to the LightScript development environment. This workspace allows you to create, test, and
                refine RGB lighting effects for the SignalRGB platform.
            </p>
            ...
            <div className="welcome-checkbox">
                <input
                    ...
                    id="dontShowAgain"
                    onChange={(e: Event) => setDontShowAgain((e.target as HTMLInputElement).checked)}
                    type="checkbox"
                />
            ...
            <div className="welcome-footer">
                ...
                >
                    <svg aria-label="GitHub" fill="currentColor" height="18" role="img" viewBox="0 0 24 24" width="18">
                        <title>GitHub</title>
